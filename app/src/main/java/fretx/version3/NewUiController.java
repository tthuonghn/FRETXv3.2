...
public class NewUiController implements Observer, OnItemSelectedListener {
	public static final String TAG = "GuitarTuner";

	public static double test = 0f;

	private LearnFragmentTuner ui;
	...
	public NewUiController(LearnFragmentTuner u) {
		ui = u;
	}
	...
	public void updateUi() {
		...
		Log.d("+++","StringId+++++++++++++++++" + current.stringId);
		String stringName ="";
